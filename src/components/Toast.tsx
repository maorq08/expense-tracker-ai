    ...
    <ToastContext.Provider value={{ toast }}>
      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-2 pointer-events-none">
        {toasts.map((t) => (
          <div
            key={t.id}
            className={`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl border bg-gradient-to-r shadow-lg min-w-[280px] max-w-sm ${bgColors[t.type]} glass-strong ${t.exiting ? "animate-slide-out-right" : "animate-slide-in-right"}`}
          >
            {icons[t.type]}
